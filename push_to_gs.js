...
var TOKEN_DIR = (process.env.HOME || process.env.HOMEPATH ||
    process.env.USERPROFILE) + '/.credentials/'; // @TODO: change path to local dir + .gitignore
        ...
        resource: {
            requests: {
                updateCells: {
                    ...
                    rows: { values : spreadSheetsHeader.map(function (tKey) {
                                return  { userEnteredValue: { stringValue: tKey },
